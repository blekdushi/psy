...
| --------------------------------------------------------------------- | -------- | -------- | --------------------- | ---------------------- |
| Elektroenzephalographie (EEG)                                         | niedrig  | hoch     | korrelativ            | topos                  |
| Magnetenzephalographie (MEG)                                          | hoch     | hoch     |                       | topos                  |
| funktionelle und strukturelle Magnetresonanztomographie  (fMRT, sMRT) | hoch     | niedrig         | korrelativ            | tomos                  |
| Positronenemissionstomographie (PET)                                  |          |          | korrelativ            | tomos                  |
| Transkranielle Magnetstimulation (TMS)                                |          |          | kausal                |                        |
| Transkranielle Gleichstromstimulation (tDCS)                          |          |          | kausal                |                        |
| Läsionsstudien                                                        | niedrig  | niedrig  | kausal                |                        |


TODO: tabellarische Darstellung der Methoden mit Angabe der obigen Klassifizierungen

## Artefakte

<q>**Artefakte** bei physiologischen Messungen sind Signale, die nicht durch den interessierenden physiologischen bzw. biopsychologischen Prozess, sondern durch andere Faktoren (z. B. externe Quellen elektrischer Potenziale wie etwa Radiosender oder Mobiltelefone) verursacht werden. Es handelt sich also um Signale, die einen anderen Ursprung haben als das interessierende Biosignal.</q> (Hussy et al., 2013, S.103)
...
Dafür werden Elektroden in der Regel systematisch (z.B. "10/20 System") mit Hauben an der Schädeloberfläche und eine Referenzelektrode am Ohr befestigt.
...
| Gamma     | ~40      | gering    | Integration visueller Wahrnehmung |
...
Allgemein auch **event related potential (ERP)** genannt, unterscheidet man...
* sensorisch (Wahrnehmung)
* motorisch (vor einer Bewegung)
* endogene (kognitive Prozesse)

...evozierte Potenziale. Die Ausschläge (positiv - P und negativ - N) werden dann entlang einer Zeitachse eingetragen und mit dem Zeitpunkt des Auftretens refereniert (z.B. P100 für einen positiven Ausschlag bei 100ms nach Einsetzen des Reizes).

Um ERP von der Spontanaktivität unterscheiden zu können, bietet man den Reiz öfters dar, mittelt dann die Durchgänge um das _Signal_ zu vestärken und das Rauschen (Spontanaktivität) zu reduzieren -> **grand average**

Augenbewegungen und Lidschläge sind typische Artefakte bei EEG Messungen.

Experiment: Hilfslosigkeit erzeugen bei Vpn. Danach Aufgabe erledigen lassen. Beobachten des Verhaltens und Messen der ERP: keine Unterschiede der Vpn bei Verhalten, aber Unterschiede bei ERP.
...
Bei der **funktionellen Magnetresonanztomografie (fMRT)** (engl. functional magnet resonance imaging) stehen die unterschiedlichen magnetischen Eigenschaften von sauerstoffreichem und -armen Hämoglobin im Mittelpunkt. Aktive Regionen im ZNS brauchen mehr Sauerstoff und sind deshalb besser durchblutet (_hämodynamische Antwort_).

Das fMRT visualisiert als nur _indirekt_ die neuronale Aktivtität über den Umweg der Blutversorgung: [blood oxygen level dependent](https://psychology.wikia.org/wiki/BOLD_response). Dieses und somit die fMRT Ergebnisse können aber abhängig von Alter, Substanzen, Aufregung, Hyperventilation... beeinflusst sein.

Berechnung von BOLD-Differenzen (z.B. Aufgabe minus Pause)
...
-> Was die BOLD-Antwort genau widerspiegelt wird erforscht!

Experimente: Stich mit Nadel in die Hand oder andere Hautstellen, Ansehen von Bildern.... Wie reagiert das Gehirn dabei?
...
Bei der **[trankranielle Gleichstromstimulation (tDCS)](https://psychology.wikia.org/wiki/Transcranial_direct-current_stimulation)** stimuliert man wie bei der TMS bestimmte Areale im Gehirn. Jedoch nicht über Magnetfelder, sondern mit Gleichstrom, der über Elektroden angebracht wird. Dadurch verändert man das Ruhepotenzial der Neuronen und kann somit exzitatorisch bzw. inhibitatorsich eingreifen. Je nach stimuliertem Areal lassen sich Leistungssteigerungen beim Sport, Rechnen, Gedächtnis, Sprache... erzielen und die tDCS wurde/wird deshalb bei Patienten mit Hirnschäden (z.B. Schlaganfall) eingesetzt. Ermöglicht Testen kausaler Hypothesen.

Experiment:

# Zusammenfassung zu Methoden
-> Vielzahl an bio-psychologischen Methoden existiert (mittlerweile)
-> Erlauben Zugang zu unterschiedlichen physiologischen Prozessen
-> jede Methode hat Vor- und Nachteile (z.b. räumliche und zeitliche Auflösung, Korrelation vs. Kausation, Durchführbarkeit, Kosten, ...)
-> viele mentale Prozesse nach wie vor nicht zugänglich/schwer fassbar
-> bio-psychologische Methoden sind nur ein Teil psychologischer Forschung(smethoden)

# Zusammenfassung allgemein
-> unter den Auffassungen vom Gehirn-Geist-Verhältnis dominiert der materialistische Monismus
-> bio-psychologische Methoden haben diese Auffassung geprägt
-> es existiert eine Vielzahl an bio-psychologischen Methoden, die Zugang zu unterschiedlichen neuronalen Prozessen liefern
-> diese sind aber lediglich ein Aspekt psychologischer Forschung(smethoden), und als komplementär zu sehen (Konzept der Analyseebenen)
-> viele Bereiche des Psychischen bis heute, trotz Hirnforschung, kaum verständlicher

# Literatur

<div class="csl-bib-body" style="line-height: 2; margin-left: 2em; text-indent:-2em;">
  <div class="csl-entry">Bernadette von Dawans, Urs Fischbacher, Clemens Kirschbaum, Ernst Fehr, &amp; Markus Heinrichs. (2012). The Social Dimension of Stress Reactivity: Acute Stress Increases Prosocial Behavior in Humans. <i>Psychological Science</i>, <i>23</i>(6), 651–660. <a href="https://doi.org/10.1177/0956797611431576">https://doi.org/10.1177/0956797611431576</a></div>
  <span class="Z3988" title="url_ver=Z39.88-2004&amp;ctx_ver=Z39.88-2004&amp;rfr_id=info%3Asid%2Fzotero.org%3A2&amp;rft_id=info%3Adoi%2F10.1177%2F0956797611431576&amp;rft_val_fmt=info%3Aofi%2Ffmt%3Akev%3Amtx%3Ajournal&amp;rft.genre