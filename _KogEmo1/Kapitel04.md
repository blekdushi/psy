...
Im Gegensatz zu dimensionalen Modellen, die Emotionen entlang stetiger Dimensionen quantitativ verorten, unterteilen **kategoriale Modelle** Emotionen qualitativ. In der Regel unterscheiden sie zwischen Basisemotionen, die angeboren und universell sind (_evolutionspsychologisch_), und Sekundäremotionen, die auf Basisemotionen aufbauen und durch Kognitionen oder soziale Einflüsse geformt werden. Die Mehrheit dieser Modelle stimmen beiden Basisemotionen mit den prototypischen Zuständen vom Circumplex-Modell (siehe Aufzählung oben) überein. Weitere genannte Emotionen sind:
* Interesse
* Schuld
* Verachtung
* Scham
...
* Limbische System
* Amygdala
* Papez circuit: Cingulate cortex -> Hippocampus -> Hypothalamus -> Thalamus -> Cingulate cortex
...
* Aufmerksamkeit auf Emotion oder gezielt davon weg richten
* Kognitive Umbewertung
* Kontrolle der Situation (z.B. Durchatmen, Mimik unterdrücken...)
